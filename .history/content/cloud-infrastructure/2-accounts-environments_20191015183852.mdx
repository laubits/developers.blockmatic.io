...
Each environment within Emanate infrastructure get its own subdomain and dele with the exception of the production environment. `{environment}.emanate.live`
